...
MODEL                     = APP_MyApplicationT5_
MODULES                   = 
MAKEFILE                  = APP_MyApplicationT5_.mk
MATLAB_ROOT               = C:/LegacyApp/Matlab18b/R2018b
S_FUNCTIONS               = 
S_FUNCTIONS_LIB           = 
NUMST                     = 1
NCSTATES                  = 0
BUILDARGS                 = _MBDS_DIR="C:\Program Files\MBDS_v0820" _PROJECT_DIR="C:\Proj\BSG_EVO\TestApp\__eBSG__MASTER\RT_Test_eBSG_Master_010001" _PROJECT_NAME="RT_Test_eBSG_Master_010001" _RESOURCETYPE=eBSG_EVO_MASTER _TASK_INDEX=5 _OUTPUTMODE=SL-Library _DEBUGMODE=On _PRODUCTION_CODE= MODELLIB=APP_MyApplicationT5_lib.lib GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING SHARED_SRC_DIR=../slprj/MBDS/_sharedutils SHARED_BIN_DIR=../slprj/MBDS/_sharedutils
MULTITASKING              = 0
INTEGER_CODE              = 0
MAT_FILE                  = 0
ONESTEPFCN                = 1
...
ADD_INCLUDES = \
	...
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__MASTER/RT_Test_eBSG_Master_010001/Work/APP_MyApplicationT5__MBDS_rtw \
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__MASTER/RT_Test_eBSG_Master_010001/Applications/APP_MyApplicationT5 \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
