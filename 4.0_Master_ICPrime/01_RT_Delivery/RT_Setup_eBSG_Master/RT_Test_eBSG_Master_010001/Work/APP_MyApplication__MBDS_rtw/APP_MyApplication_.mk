...
MODEL                     = APP_MyApplication_
MODULES                   = APP_MyApplication__data.c
MAKEFILE                  = APP_MyApplication_.mk
MATLAB_ROOT               = C:/LegacyApp/Matlab18b/R2018b
S_FUNCTIONS               = 
S_FUNCTIONS_LIB           = 
NUMST                     = 1
NCSTATES                  = 0
BUILDARGS                 = _MBDS_DIR="C:\Program Files\MBDS_v0820" _PROJECT_DIR="C:\Proj\BSG_EVO\TestApp\__eBSG__MASTER\RT_Test_eBSG_Master_010001" _PROJECT_NAME="RT_Test_eBSG_Master_010001" _RESOURCETYPE=eBSG_EVO_MASTER _TASK_INDEX=1 _OUTPUTMODE=SL-Library _DEBUGMODE=On _PRODUCTION_CODE= MODELLIB=APP_MyApplication_lib.lib GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING SHARED_SRC_DIR=../slprj/MBDS/_sharedutils SHARED_BIN_DIR=../slprj/MBDS/_sharedutils
MULTITASKING              = 0
INTEGER_CODE              = 0
MAT_FILE                  = 0
ONESTEPFCN                = 1
...
#-- Additional includes 
ADD_INCLUDES = \
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__MASTER/RT_Test_eBSG_Master_010001/Work \
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__MASTER/RT_Test_eBSG_Master_010001/Work/APP_MyApplication__MBDS_rtw \
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__MASTER/RT_Test_eBSG_Master_010001/Applications/APP_MyApplication \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
	-I$(MATLAB_ROOT)/rtw/c/ert \
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__MASTER/RT_Test_eBSG_Master_010001/Work/slprj/MBDS/_sharedutils \
...
%.o : $(subst \,/,$(MATLAB_ROOT)/rtw/c/src)/%.c $(COMPILER_OPTIONS_FILE)
	  @echo ### ------------------------------------------------------------
	  @echo ### Creating TLC included object $@
	  @echo ### ------------------------------------------------------------
	  $(COMPILE) $< $(STD_INCLUDES) $(TARGET_INCLUDES) $(RTW_INCLUDES) $(CGEN_INCLUDES) @$(COMPILER_OPTIONS_FILE) $(CPP_REQ_DEFINES) $(COMPILER_OPTIONS) -DRTMEM_TASK_INDEX=$(_TASK_INDEX)
	  @echo ### Compiled $@
%.o : $(subst \,/,$(MATLAB_ROOT)/simulink/src)/%.c $(COMPILER_OPTIONS_FILE)
	  @echo ### ------------------------------------------------------------
	  @echo ### Creating TLC included object $@
	  @echo ### ------------------------------------------------------------
	  $(COMPILE) $< $(STD_INCLUDES) $(TARGET_INCLUDES) $(RTW_INCLUDES) $(CGEN_INCLUDES) @$(COMPILER_OPTIONS_FILE) $(CPP_REQ_DEFINES) $(COMPILER_OPTIONS) -DRTMEM_TASK_INDEX=$(_TASK_INDEX)
...
./PiL/%.o : $(subst \,/,$(MATLAB_ROOT)/rtw/c/src)/%.c $(PIL_COMPILER_OPTIONS_FILE)
	  @echo ### ------------------------------------------------------------
	  @echo ### Creating TLC included object $@
	  @echo ### ------------------------------------------------------------
	  $(COMPILE) $< $(STD_INCLUDES) $(TARGET_INCLUDES) $(RTW_INCLUDES) -G @$(PIL_COMPILER_OPTIONS_FILE) $(CPP_REQ_DEFINES) $(COMPILER_OPTIONS) -object_dir=./PiL
	  @echo ### Compiled $@
./PiL/%.o : $(subst \,/,$(MATLAB_ROOT)/simulink/src)/%.c $(PIL_COMPILER_OPTIONS_FILE)
	  @echo ### ------------------------------------------------------------
	  @echo ### Creating TLC included object $@
	  @echo ### ------------------------------------------------------------
	  $(COMPILE) $< $(STD_INCLUDES) $(TARGET_INCLUDES) $(RTW_INCLUDES) -G @$(PIL_COMPILER_OPTIONS_FILE) $(CPP_REQ_DEFINES) $(COMPILER_OPTIONS) -object_dir=./PiL
