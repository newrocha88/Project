...
NUMST                     = 1
NCSTATES                  = 0
BUILDARGS                 = _MBDS_DIR="C:\Program Files\MBDS_v0820" _PROJECT_DIR="C:\Proj\BSG_EVO\TestApp\__eBSG__BTMS\RT_Test_eBSG_BTMS_010001" _PROJECT_NAME="RT_Test_eBSG_BTMS_010001" _RESOURCETYPE=eBSG_EVO_BTMS _TASK_INDEX=3 _OUTPUTMODE=SL-Library _DEBUGMODE=On _PRODUCTION_CODE= MODELLIB=APP_MyApplicationT3_lib.lib GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING SHARED_SRC_DIR=../slprj/MBDS/_sharedutils SHARED_BIN_DIR=../slprj/MBDS/_sharedutils
MULTITASKING              = 0
INTEGER_CODE              = 0
MAT_FILE                  = 0
ONESTEPFCN                = 1
...
ADD_INCLUDES = \
	...
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__BTMS/RT_Test_eBSG_BTMS_010001/Work/APP_MyApplicationT3__MBDS_rtw \
	-IC:/Proj/BSG_EVO/TestApp/__eBSG__BTMS/RT_Test_eBSG_BTMS_010001/Applications/APP_MyApplicationT3 \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
