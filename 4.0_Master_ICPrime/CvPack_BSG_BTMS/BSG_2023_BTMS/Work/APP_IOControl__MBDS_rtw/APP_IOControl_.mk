...
NUMST                     = 1
NCSTATES                  = 0
BUILDARGS                 = _MBDS_DIR="C:\Program Files\MBDS_v0820" _PROJECT_DIR="C:\Users\uie79669\OneDrive - Continental AG\Projects\SDBox_MAN_Master_Expansion\Felipe_Teste\BSG_2023_BTMS" _PROJECT_NAME="BSG_2023_New" _RESOURCETYPE=eBSG_EVO_BTMS _TASK_INDEX=3 _OUTPUTMODE=SL-Library _DEBUGMODE=On _PRODUCTION_CODE= MODELLIB=APP_IOControl_lib.lib GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING SHARED_SRC_DIR=../slprj/MBDS/_sharedutils SHARED_BIN_DIR=../slprj/MBDS/_sharedutils
MULTITASKING              = 0
INTEGER_CODE              = 0
MAT_FILE                  = 0
ONESTEPFCN                = 1
...
#-- Additional includes 
ADD_INCLUDES = \
	-I$(subst \,/,$(PROJECT_DIR))/Work \
	-I$(subst \,/,$(PROJECT_DIR))/Work/APP_IOControl__MBDS_rtw \
	-I$(subst \,/,$(PROJECT_DIR))/APPLIC~1/APP_IO~1 \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
	-I$(MATLAB_ROOT)/rtw/c/ert \
	-I$(subst \,/,$(PROJECT_DIR))/Work/slprj/MBDS/_sharedutils \
